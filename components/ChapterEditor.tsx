...
import { SparklesIcon, ClipboardIcon, TextSelectIcon, GrammarIcon, UsersIcon, GlobeAltIcon } from './Icons';
    ...
    autosaveTimeoutRef.current = window.setTimeout(() => {
      ...
      updateActiveStory(prevStory => {
          ...
          const newVersion: Version = {
              ...
              storyState: JSON.parse(JSON.stringify(storyWithCurrentChapter))
          };
          return {
