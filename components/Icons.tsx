...
export const ListOrderedIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6h12M8.25 12h12M8.25 18h12M3.75 6H3.75m0 6H3.75m0 6H3.75" />
    </svg>
);
...
export const AlignRightIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" transform="rotate(180 12 12)" />
    </svg>
);

export const AgentIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5l.415-.207a.75.75 0 011.085.67V10.5m0 0h6m-6 0a.75.75 0 001.085.67l.415-.207M8.25 10.5V6.75a.75.75 0 01.75-.75h4.5a.75.75 0 01.75.75v3.75m0 0A2.25 2.25 0 0113.5 12h-3a2.25 2.25 0 01-2.25-1.5m1.5 0a.75.75 0 001.085.67l.415-.207m0 0l.415.207a.75.75 0 001.085-.67V7.5m-1.5 3a2.25 2.25 0 00-3 2.25v.75a2.25 2.25 0 003 2.25h3a2.25 2.25 0 003-2.25v-.75a2.25 2.25 0 00-3-2.25h-3z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.15c-1.104.044-2.03.992-2.03 2.093v.357c0 .587-.217 1.126-.584 1.543l-1.457 1.527a.75.75 0 01-1.06 0l-1.457-1.527a2.25 2.25 0 00-.584-1.543v-.357c0-1.101-.926-2.049-2.03-2.093l-3.72-.15c-1.133-.093-1.98-1.057-1.98-2.193V10.608c0-.97.616-1.813 1.5-2.097L6.75 8.25m.75 12.75c.621 0 1.125-.504 1.125-1.125V19.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h4.125z" />
    </svg>
);
